...
'''
        language_markup = r'''\n<div class="rsl-language-switcher" id="rsl-language-switcher">\n  <button class="rsl-language-trigger" id="rsl-language-trigger" type="button" aria-haspopup="true" aria-expanded="false">\n    <span class="rsl-language-globe" aria-hidden="true">◎</span>\n    <span id="rsl-language-label">English</span>\n    <span class="rsl-language-chevron">⌃</span>\n  </button>\n  <div class="rsl-language-menu" id="rsl-language-menu" hidden>\n    <button type="button" class="rsl-language-option is-active" data-language="English">English</button>\n    <button type="button" class="rsl-language-option" data-language="Español" disabled>Español</button>\n    <button type="button" class="rsl-language-option" data-language="Français" disabled>Français</button>\n    <button type="button" class="rsl-language-option" data-language="Deutsch" disabled>Deutsch</button>\n    <button type="button" class="rsl-language-option" data-language="Português" disabled>Português</button>\n    <button type="button" class="rsl-language-option" data-language="日本語" disabled>日本語</button>\n    <button type="button" class="rsl-language-option" data-language="한국어" disabled>한국어</button>\n    <button type="button" class="rsl-language-option" data-language="中文" disabled>中文</button>\n  </div>\n</div>\n<script>\n(function(){\n  const trigger=document.getElementById("rsl-language-trigger");\n  const menu=document.getElementById("rsl-language-menu");\n  const label=document.getElementById("rsl-language-label");\n  if(!trigger||!menu)return;\n  const close=()=>{menu.hidden=true;trigger.setAttribute("aria-expanded","false");};\n  trigger.addEventListener("click",e=>{e.stopPropagation();menu.hidden=!menu.hidden;trigger.setAttribute("aria-expanded",String(!menu.hidden));});\n  document.addEventListener("click",e=>{if(!menu.contains(e.target)&&e.target!==trigger)close();});\n  document.addEventListener("keydown",e=>{if(e.key==="Escape")close();});\n  const saved=localStorage.getItem("rsl-language")||"English";\n  if(label)label.textContent=saved;\n  menu.querySelectorAll(".rsl-language-option").forEach(option=>{\n    if(option.dataset.language===saved)option.classList.add("is-active");\n    option.addEventListener("click",()=>{\n      localStorage.setItem("rsl-language",option.dataset.language);\n      if(label)label.textContent=option.dataset.language;\n      menu.querySelectorAll(".rsl-language-option").forEach(x=>x.classList.remove("is-active"));\n      option.classList.add("is-active");\n      close();\n    });\n  });\n})();\n</script>\n'''\n        if "</body>" in body:\n            body = body.replace("</body>", language_markup + "</body>", 1)\n\n        if "</nav></header>" in body:
