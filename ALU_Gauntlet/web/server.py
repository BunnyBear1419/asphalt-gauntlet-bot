...
class WebControlCenter:
    ...
    async def _page_response(self, filename: str, request: web.Request | None = None) -> web.Response:
        ...
        body = re.sub(r'/static/app\\.css\\?v=[^&"]+', '/static/app.css?v=20260925-site143', body)
...
(function(){
  ...
  if(consent&&decodeURIComponent(consent[1])==="accepted") window.rslLoadAnalytics();
        ...
        body = re.sub(
            ...
            'href="/static/app.css?v=20260925-site14"',
            body,
            flags=re.I
        )
...
'''
        ...
        if filename.endswith(".html"):
            ...
            if app_css_tag.search(body):
                body = app_css_tag.sub('<link rel="stylesheet" href="/static/app.css?v=20260925-site14">', body, count=1)
            elif re.search(r"</head>", body, flags=re.I):
                body = body.replace("</head>", '<link rel="stylesheet" href="/static/app.css?v=20260925-site14"></head>', 1)
...
.rsl-profile-trigger,.rsl-profile-menu{{border-color:var(--brand-primary)!important}}
    ...
    async def login(self, request: web.Request) -> web.StreamResponse:
        ...
        return web.Response(
            text=f"""<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Sign In • Racing Syndicate League</title><link rel="stylesheet" href="/static/app.css?v=20260925-site14"></head><body class="alu-dashboard"><main style="min-height:100vh;display:grid;place-items:center;padding:32px"><section class="glass-panel" style="max-width:620px;width:100%;padding:42px;text-align:center"><div class="bottom-logo">RACING <b>SYNDICATE</b> <strong>LEAGUE</strong></div><h1>Sign In to Racing Syndicate League</h1><p class="server-sub">Use your Discord account to access your player profile, registration, matches and staff controls. Your secure web session will be remembered for up to 30 days and refreshed while you use the site.</p><a class="qa qa-purple" href="{self.auth.login_url(state)}">Continue with Discord →</a></section></main></body></html>""",
